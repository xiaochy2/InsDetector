                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <div class="carousel-caption">
                            ...
                            <p>
                                Fetch images from Instagram by user name.
                            </p>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="carousel-caption">
                            ...
                            <p>
                                Search information from images though Google Vision API.
                            </p>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="carousel-caption">
                            ...
                            <p>
                                Analyse the type of images though Leiki API.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    $(function(){
        ...
        for (var j=0;j<aA.length;j++){
            ...
            aA[j].onclick=function() {
                this.href="show.action?imgId="+this.name+"&imgUrl="+aImg[this.index].src;
                $.ajax({
                    type: "POST",
                    url: "show.action",
                    data: {
